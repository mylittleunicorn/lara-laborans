...
<div class="block justify-between items-center p-4 mx-4 mt-4 mb-6 bg-white shadow-xl shadow-gray-200 lg:p-5 sm:flex">
  <div class="mb-1 w-full">
    <div class="mb-4">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2">
          <li class="inline-flex items-center">
            <a href="{{route('dashboard.index')}}" class="inline-flex items-center text-gray-700 hover:text-gray-900">
              ...
              <span class="ml-1 text-sm text-gray-700 hover:text-gray-900 md:ml-2">
                Dashboard
              </span>
            </a>
          </li>
          <li>
            <div class="flex items-center">
              ...
              <a href="{{ route('programstudy.index') }}" class="ml-1 text-sm text-gray-700 hover:text-gray-900 md:ml-2">Program Study</a>
            </div>
          </li>
          <li>
            <div class="flex items-center">
              ...
              <span class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2">
                List
              </span>
            </div>
          </li>
      ...
      <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl">All Program Study</h1>
    </div>
    ...
    <div class="block items-center sm:flex md:divide-x md:divide-gray-100">
      <form class="mb-4 sm:pr-3 sm:mb-0" action="#" method="GET">
        ...
        <div class="static mt-1 sm:w-64 xl:w-96">
          <input type="text" name="email" id="products-search" class=" text-gray-900 sm:text-sm border-b-2 focus:outline-none focus:border-teal-600  block w-full p-2.5" placeholder="Search for program study">
        </div>
      </form>
      <div class="flex items-center w-full sm:justify-end">
        ...
        <a href="{{ route('programstudy.create') }}" class="inline-flex sm:ml-auto">
          <button type="button" data-modal-toggle="add-product-modal" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-gradient-to-br from-teal-500 to-voilet-500 sm:ml-auto shadow-md shadow-gray-300 hover:scale-[1.02] transition-transform" href="{{ route('programstudy.create') }}">
...
<div class="flex items-center bg-teal-500 text-white text-sm font-bold px-4 py-3 my-8 md:mx-8" role="alert">
